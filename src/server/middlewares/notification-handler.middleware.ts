...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'TaskCreated.create': { roles: ['contributor', 'viewer'], key: 'task_id', tenantPath: [], userPath: [] },
  'IssueReported.create': { roles: ['contributor', 'viewer'], key: 'issue_id', tenantPath: [], userPath: [] },
  'ProjectUpdated.update': { roles: ['contributor', 'viewer'], key: 'project_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['viewer'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['contributor', 'viewer', 'end-user'];
