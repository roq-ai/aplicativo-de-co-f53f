...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Aplicativo de compartilhamento de pessoal`}</title>

        <meta
          name="description"
          content="Aplicativo de compartilhamento de pessoal: Empowering people to connect, converse and share unused objects or specific knowledge with others who need them"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Aplicativo de compartilhamento de pessoal`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Aplicativo de compartilhamento de pessoal: Empowering people to connect, converse and share unused objects or specific knowledge with others who need them`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Viewer" type="viewer" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
